...
last_verified_commit: b9b4fd335
...
| `C-0021` | 2026-07-03 | structural registry authority | `P5-WP02..03` | P-058, P-061, P-069 | Make one closed typed registry contract authoritative for the canonical envelope, correlation, provenance, signal payload arms, trace resource/scope/status/events/links, metric samples, privacy classes, conditions, lifecycle phase/code values, and canonical-to-OTLP representations. Generated schemas, builders, catalogs, fixtures, projections, and validators consume that materialized contract; prose and renderer-local structural assumptions are not authority. | in progress |
