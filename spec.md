...
last_verified_commit: df0d16382
...
| `C-0021` | 2026-07-03 | structural registry authority | `P5-WP02..03` | P-058, P-061, P-069 | Make one closed typed registry contract authoritative for the canonical envelope, correlation, provenance, signal payload arms, trace resource/scope/status/events/links, metric samples, privacy classes, conditions, lifecycle phase/code values, and canonical-to-OTLP representations. The source/compiler/runtime foundation is verified at `df0d16382`; generated schemas, builders, catalogs, fixtures, and projections must consume the same immutable materialized view before this decision is complete. | in progress |
