...
def _schema_type(field_type: str) -> JSONObject:
    ...
    if field_type == "array":
        return {"type": "array"}
    if field_type in {"object", "canonical_json"}:
        return {} if field_type == "canonical_json" else {"type": "object"}
    ...
    if family_type == "log":
        ...
        overlay_properties["body"] = {
            "allOf": [
                ...
                {"type": "object", "properties": body_properties},
            ]
        }
...
def render_candidate_artifacts(view: object) -> Mapping[str, CandidateArtifact]:
    ...
    def add_json(relative: str, document: JSONObject) -> None:
        ...
        artifacts[path] = CandidateArtifact(path, _json_payload(document), "application/json", JSON_OWNERSHIP_MARKER)
    ...
    artifacts[markdown_path] = CandidateArtifact(
        markdown_path,
    ...
    return MappingProxyType({path: artifacts[path] for path in sorted(artifacts)})
